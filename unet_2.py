...
class fin_conv(nn.Sequential):
    ...
    def __init__(
        ...
        Args:
            ...
            last_act: activation type and arguments.
...
class BasicUNet(nn.Module):
    ...
    def __init__(
        ...
        Based on:
            ...
            Morphometry". Nature Methods 16, 6770 (2019), DOI:
        ...
        self.final_conv = fin_conv(fea[5], out_channels, kernel_size=1)
